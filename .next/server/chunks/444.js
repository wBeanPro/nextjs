...
/* harmony export */   "q": () => (/* binding */ getI18nSSRProps)
/* harmony export */ });
...
const getI18nSSRProps = async ({
  locale
}, localeArr) => {
  // 按需加载国际化数组
  const i18nProps = await (0,next_i18next_serverSideTranslations__WEBPACK_IMPORTED_MODULE_0__.serverSideTranslations)(locale, ["common", ...localeArr]);
  const {
    title
  } = i18nProps._nextI18Next.initialI18nStore[locale][localeArr[0]];
  return _objectSpread(_objectSpread({}, i18nProps), {}, {
    title
  });
};
